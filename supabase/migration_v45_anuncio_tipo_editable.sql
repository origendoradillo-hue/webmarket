-- Ejecutar en el SQL Editor de Supabase después de migration_v44_anuncio_whatsapp.sql.
-- El "tipo" de un anuncio (evento/aviso barrial/sponsor/...) solo se podía
-- fijar al crearlo (solicitar_anuncio); si el staff necesitaba cambiarlo
-- después no había forma de hacerlo desde el panel.
