...
export const LISTINGS: Listing[] = [
  ...
  { id: 25, nombre: "Excursiones 4x4 Golfo Nuevo", intencion: "ofrezco", tipo: "experiencia", categoria: "turismo", subcategoria: "Excursiones 4x4", zona: "Zona 1", icono: "ti-car", sello: false, destacada: false, rating: 4.6, reseñas: 10, modalidad: ["A domicilio"], descripcion: "Recorridos en 4x4 por caminos de ripio y costa del golfo.", iniciales: "GN", tipoPublicador: "productor", precio: 9500 },
  ...
  { id: 27, nombre: "Cabañas del Golfo", intencion: "ofrezco", tipo: "servicio", categoria: "hospedaje", subcategoria: "Cabañas", zona: "Zona 2", direccion: "Camino costero, km 6", icono: "ti-home", sello: true, destacada: true, rating: 4.9, reseñas: 31, modalidad: ["Retiro"], descripcion: "Cabañas equipadas con vista a la estepa, a minutos de la costa.", iniciales: "CG", tipoPublicador: "negocio", colorMarca: "#4C6B70", tags: ["cabañas", "costa", "vista al golfo"], precio: 45000 },
  { id: 28, nombre: "Hostería Refugio del Golfo", intencion: "ofrezco", tipo: "servicio", categoria: "hospedaje", subcategoria: "Hostería", zona: "Zona 2", direccion: "Camino costero, km 7", cuadrante: "Sur", icono: "ti-building", sello: false, destacada: false, rating: 4.8, reseñas: 24, modalidad: ["Retiro"], descripcion: "Hostería boutique con desayuno de productos locales incluido.", iniciales: "RG", foto: img("hosteria-refugio-del-golfo.jpg"), tipoPublicador: "productor", precio: 38000 },
  ...
  { id: 34, nombre: "Martillos usados", intencion: "ofrezco", tipo: "usado_herramienta", categoria: "usados", subcategoria: "Herramientas", zona: "Zona 3", icono: "ti-hammer", sello: false, destacada: false, rating: 0, reseñas: 0, modalidad: ["Retiro"], descripcion: "Vendo martillos usados en buen estado.", iniciales: "", tipoPublicador: "vecino", cantidad: 3, tags: ["herramientas", "usado", "martillo"], precio: 4500 },
  { id: 35, nombre: "Leña seca", intencion: "ofrezco", tipo: "usado_herramienta", categoria: "usados", subcategoria: "Otros usados", zona: "Zona 1", icono: "ti-flame", sello: false, destacada: false, rating: 0, reseñas: 0, modalidad: ["Retiro"], descripcion: "Vendo leña seca de jarilla en bolsones de 40kg.", iniciales: "", tipoPublicador: "vecino", cantidad: 6, tags: ["leña", "jarilla", "calefacción"], precio: 3000 },
  { id: 36, nombre: "Heladera usada", intencion: "ofrezco", tipo: "usado_herramienta", categoria: "usados", subcategoria: "Electrodomésticos", zona: "Zona 2", icono: "ti-fridge", sello: false, destacada: false, rating: 0, reseñas: 0, modalidad: ["Retiro"], descripcion: "Heladera de 300L en buen estado, funciona perfecto, me sobró al mudarme.", iniciales: "", tipoPublicador: "vecino", cantidad: 1, tags: ["heladera", "electrodomésticos", "usado"], precio: 90000 },
  { id: 37, nombre: "Chapas y perfiles usados", intencion: "ofrezco", tipo: "usado_herramienta", categoria: "usados", subcategoria: "Materiales de construcción", zona: "Zona 1", icono: "ti-building-warehouse", sello: false, destacada: false, rating: 0, reseñas: 0, modalidad: ["Retiro"], descripcion: "Sobrante de obra: chapas acanaladas y perfiles de hierro, buen estado.", iniciales: "", tipoPublicador: "vecino", cantidad: 12, tags: ["chapas", "materiales", "obra"], precio: 25000 },

  // Ejemplos de "busco" — sin foto ni precio obligatorio, se muestran diferenciados en la grilla.
  { id: 38, nombre: "Busco cuidador de perro por un fin de semana", intencion: "busco", categoria: "oficios", subcategoria: "Cuidado de animales", zona: "Zona 2", icono: "ti-paw", sello: false, destacada: false, rating: 0, reseñas: 0, modalidad: ["A domicilio"], descripcion: "Viajo un fin de semana y busco alguien de confianza en la zona que pueda cuidar a mi perro en casa.", iniciales: "", tipoPublicador: "vecino", tags: ["mascotas", "perro", "cuidado"] },
  { id: 39, nombre: "Busco compra de plantines de olivo", intencion: "busco", categoria: "productores", subcategoria: "Viveros y plantines", zona: "Zona 1", icono: "ti-plant", sello: false, destacada: false, rating: 0, reseñas: 0, modalidad: ["Retiro"], descripcion: "Estoy armando una chacra chica y busco plantines de olivo, cantidad a definir según precio.", iniciales: "", tipoPublicador: "vecino", tags: ["olivo", "plantines", "chacra"] },
];
